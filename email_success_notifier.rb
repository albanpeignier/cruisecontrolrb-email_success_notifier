# CruiseControl.rb can send email notices whenever build is successful. To make it happen, you need to tell it how
...
class EmailSuccessNotifier
  ...
  def build_finished(build)
    ...
    email :deliver_build_report, build, "#{build.project.name} build #{build.label} success", "The build is successful."
  end
...
Project.plugin :email_success_notifier
